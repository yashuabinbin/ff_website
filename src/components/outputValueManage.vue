<template>
  <section>
    ...
    <el-dialog title="新增" :visible.sync="addOutputValueFormVisible" :close-on-click-modal="false" width="700px">
      <el-form :model="addOutputValueForm" label-width="100px" :rules="addOutputValueFormRules"
        ...
        <el-row :span="24" v-for="(outputValueDetail) in addOutputValueForm.outputValueDetailList"
                :key="outputValueDetail.outputValueId">
          <el-col :span="12">
            <el-form-item :label="outputValueDetail.subContractorName">
              <el-input type="number" step="0.01" v-model.number="outputValueDetail.migrantWorkerAmount"
                        placeholder="请输入产值">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item :span="12" :label="outputValueDetail.subContractorName">
              <el-input type="number" step="0.01" disabled v-model.number="outputValueDetail.outputValueAmount">
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
    ...
    <!--<el-form :model="editoutputValueForm" label-width="120px" :rules="addOutputValueFormRules"-->
    <!--ref="editoutputValueForm">-->
    <!--<el-form-item label="合同" prop="contractId">-->
    <!--<el-select v-model="editoutputValueForm.contractId" filterable placeholder="请选择"-->
    <!--v-on:change="contractChange(editoutputValueForm.contractId, true)">-->
    ...
    <!--<el-autocomplete class="inline-input" v-model="editoutputValueForm.invoiceContent"-->
    <!--:fetch-suggestions="invoiceContentFilter" placeholder="请输入内容">-->
    <!--</el-autocomplete>-->
    <!--</el-form-item>-->

    <!--<el-form-item label="开票日期" prop="invoiceTime">-->
    <!--<el-date-picker v-model="editoutputValueForm.invoiceTime" type="date">-->
    <!--</el-date-picker>-->
    <!--</el-form-item>-->

    <!--<el-form-item label="含税金额" prop="beforeTaxAmount">-->
    <!--<el-input type="number" step="0.01" v-model.number="editoutputValueForm.beforeTaxAmount" auto-complete="off">-->
    <!--</el-input>-->
    <!--</el-form-item>-->

    <!--<el-form-item label="税点" prop="taxRate">-->
    <!--<el-input type="number" step="0.01" v-model.number="editoutputValueForm.taxRate" auto-complete="off">-->
    <!--<template slot="append">%</template>-->
    <!--</el-input>-->
    <!--</el-form-item>-->

    <!--<el-form-item label="备注" prop="remark">-->
    <!--<el-input type="textarea" v-model="editoutputValueForm.remark" auto-complete="off" maxlength="30"-->
    <!--show-word-limit></el-input>-->
    <!--</el-form-item>-->

    <!--<el-row :span="24">-->
    <!--<el-col :span="12" v-for="(invoiceDetail, index) in editoutputValueForm.invoiceDetailInfoList"-->
    <!--:key="invoiceDetail.key">-->
    <!--<el-form-item :label="invoiceDetail.subContractorName"-->
    <!--:prop="'invoiceDetailInfoList.' + index + '.shareRate'"-->
    <!--:rules="addOutputValueFormRules.invoiceDetailInfoList.shareRate">-->
    ...
    <!--<div slot="footer" class="dialog-footer">-->
    <!--<el-button @click.native="editoutputValueFormVisible = false">取消</el-button>-->
